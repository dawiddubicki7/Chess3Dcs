...
public class Chessboard : MonoBehaviour
{
    ...
    private void PreventCheck()
    {
        ...
        // Sending ref availableMoves, will be deleting moves that are putting king in check
    ...
    private void SimulateMoveForSinglePiece(ChessPiece cp, ref List<Vector2Int> moves, ChessPiece targetKing)
    {
        ...
        // Going through all the moves, simulate them and check if king is in check
        for (int i = 0; i < moves.Count; i++)
        {
            ...
            // Did simulation the king's move happened
            ...
            // Restore the actual chessPieces data
            cp.currentX = actualX;
            cp.currentY = actualY;
    ...
    private bool CheckForCheckmate()
    {
        ...
        {
            // King is under attack, can someone give him help?
